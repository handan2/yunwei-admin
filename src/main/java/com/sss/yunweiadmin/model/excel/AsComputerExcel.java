...
public class AsComputerExcel {
    ...
    @ExcelProperty("*硬盘容量1(GB)")
    private String diskSize1;
    @ExcelProperty("硬盘容量2(GB)")
    private String diskSize2;
    @ExcelProperty("硬盘容量3(GB)")
    private String diskSize3;
    @ExcelProperty("硬盘容量4(GB)")
    private String diskSize4;
    @ExcelProperty("是否安装安全产品")
