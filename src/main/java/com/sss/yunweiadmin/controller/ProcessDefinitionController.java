  ...
  * */
    ...
    public ProcessDefinitionVO getProcessDefinitionVO(String processDefinitionId) {
        ...
        for (ProcessFormTemplate processFormTemplate : formList) {
            ...
            if ((processFormTemplate.getFlag().equals("基本类型") || processFormTemplate.getFlag().equals("设备列表") || processFormTemplate.getFlag().equals("附件列表") ||processFormTemplate.getFlag().equals("表类型") || processFormTemplate.getFlag().equals("字段变更类型")|| processFormTemplate.getFlag().equals("隔离符")) && Strings.isNullOrEmpty(processFormTemplate.getGroupParentLabel())) {
